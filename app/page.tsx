...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-linear-to-br from-blue-900/60 via-purple-900/50 to-indigo-900/60" />
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="max-w-lg w-full bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 text-center border border-white/30">
          ...
          <div className="space-y-4">
            <Link
              href="/register"
              className="block w-full bg-linear-to-r from-blue-600 to-indigo-600 text-white py-4 px-6 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-105 shadow-lg"
            >
